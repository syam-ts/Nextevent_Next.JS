...
const HomeEventTypes = () => {
    return (
        <div className="relative z-10 overflow-hidden bg-white pb-12 pt-20 lg:pb-[90px] lg:pt-[120px] bg-dark">
                    ...
                    <div className="w-full px-4">
                        <div className="mx-auto mb-[60px] max-w-[510px] text-center">
                            ...
                            <p className="text-base text-body-color text-black">
                                Events are made to make memorable emotions of people and aspets.
                                Make it as much better and we help you for that.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="mx-4 flex flex-wrap justify-center">
                    <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                        <div className="relative z-10 mb-10 overflow-hidden rounded-[10px] border-2 border-stroke bg-white px-8 py-10 shadow-pricing sm:p-12 lg:px-6 lg:py-10 xl:p-[50px] border-dark-3 bg-dark-2">
                            ...
                            <img src="/organizer/event-1.jpg" className="w-96 h-96" />
                            <a
