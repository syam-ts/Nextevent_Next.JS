            ...
            <div className="w-full max-w-2xl mx-auto">
                ...
                >
                    ...
                    <div className="mt-8 flex flex-col text-center sm:flex-row gap-4">
                        <Link href='/organizer/profile/edit' className="flex-1 py-3.5 px-6 bg-gradient-to-r from-indigo-600 to-indigo-700 hover:from-indigo-700 hover:to-indigo-800 text-white font-semibold rounded-xl shadow-lg transition-all duration-200 transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            Edit Profile
                        </Link>
                    </div>
                </div>
