        ...
        <div className="bg-white mt-44">
            <div className="mx-auto py-16 sm:px-6 lg:px-8">
                <div
                 ...
                 px-6 py-24 text-center sm:rounded-3xl sm:px-16"
                >
                    <h2
                        className="font-nudge-extrabold mx-auto 
                    max-w-2xl text-3xl font-bold uppercase tracking-wide sm:text-4xl"
                    >
                    ...
                    <div className="mt-12 flex items-center justify-center gap-x-6">
                        <button
                            type="button"
                            className="text-md relative inline-flex items-center gap-x-2 
                            rounded-lg bg-indigo-600 px-6 py-3 font-semibold text-white shadow-sm
                    ...
                    >
                        ...
                        <defs>
                            <radialGradient id="827591b1-ce8c-4110-b064-7cb85a0b1217">
                                ...
                                <stop offset="1" stop-color="#4f39f6"></stop>
                            </radialGradient>
                        </defs>
                    </svg>
                </div>
